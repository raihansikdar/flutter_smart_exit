...
class _FlutterSmartExitState extends State<FlutterSmartExit> {
  ...
  void exitBottomSheet() {
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return Container(
          height: widget.bottomSheetHeight  ?? ((size.width > 550) ?  205 : 185),
            ...
            child: Column(
              ...
              children: [
                Container(
                    ...
                    child: Image.network("https://raw.githubusercontent.com/raihansikdar/flutter_smart_exit/main/gif/exit.gif",height: size.width > 550 ? size.height * 0.080 : size.height * 0.045,)),
